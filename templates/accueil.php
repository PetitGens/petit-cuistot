    ...
    ?>
        <div class="container py-4 py-xl-5"><img style="width: 100%;height: 20em;" src="assets/img/batiment.png">
            <div class="row mb-5">
                ...
                <div class="col-md-8 col-xl-6 text-center mx-auto" style="width: initial;">
                    ...
                    foreach($recettes as $recette){
                        ...
                        <div class="row">
                            <div class="col" style="text-align: left;"><img style="width: 50%;display: inline-block;position: initial;margin: 15px;padding: initial;margin-left: 0px;" src="assets/img/Pticuisto.png">
                                <div style="display: inline-block;">
                                    <h1 style="width: 50%;display: block;"><?php$recette->getTitre()></h1>
                                    <p style="display: block;"><?php$recette->getResume()></p>
                                </div>
                            </div>
                        </div>
